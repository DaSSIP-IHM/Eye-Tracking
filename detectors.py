...
def saccade_detection(x, y, time, missing=0.0, minlen=5, maxvel=1000, maxacc=340):
...
if __name__ == '__main__':
	filename = 'all_gaze_data-417077729632'
	df = pd.read_excel(r'gaze_data/' + filename+'.xlsx')

	Sfix, Efix = fixation_detection(df['x'], df['y'], df['system_time_stamp'])
